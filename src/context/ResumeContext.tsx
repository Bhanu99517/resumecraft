...
const initialData: ResumeData = {
  personalInfo: {
    ...
    summary: 'Passionate Full Stack Developer with 5+ years of experience in building scalable web applications using React, Node.js, and Cloud technologies. Proven track record of delivering high-quality software solutions.',
  },
  experience: [
    {
      id: '1',
      ...
      description: 'Led a team of 5 developers to build a high-traffic e-commerce platform. Optimized database queries resulting in 40% faster load times.',
    },
    {
      id: '2',
      ...
      duration: '2018 - 2021',
      description: 'Developed and maintained multiple client websites using React and Tailwind CSS. Implemented responsive designs and accessibility features.',
    },
  ],
  education: [
    {
  ...
  organizations: [
    {
      ...
      description: 'Contributed to various open-source projects and mentored junior developers.',
    },
  ],
  customization: {
    primaryColor: '#1e293b',
